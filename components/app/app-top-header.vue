      ...
      <div class="flex justify-between items-center border-b-2 border-gray-100 py-4 md:justify-start md:space-x-10">
        <div class="flex justify-start lg:w-0 lg:flex-1">
          <nuxt-link to="/">
            ...
            <img src="/logo.svg" class="h-10 w-10 sm:h-12 sm:w-12 rounded-full"/>
          </nuxt-link>
        </div>
        ...
        <nav class="hidden md:flex space-x-10">
          <a href="#" class="text-base font-medium text-gray-500 hover:text-gray-900"> Quran </a>
          <a href="#" class="text-base font-medium text-gray-500 hover:text-gray-900"> Hadith </a>
        </nav>
        <div class="hidden md:flex items-center justify-end md:flex-1 lg:w-0">
          <nuxt-link to="/sign-in" class="whitespace-nowrap text-base font-medium text-gray-500 hover:text-gray-900"> Sign in </nuxt-link>
          <btn link="/sign-up">
            Sign up
          </btn>
        </div>
